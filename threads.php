...
<body>
    ...
    <div class="container col-md-8 my-4">
        <div class="card ">
            <h1 class="card-header bg-dark text-light">
    ...
    <div class="container col-md-8 my-5" id="space">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($login and strtolower($_SESSION['username']) == strtolower($user_name)) {
                ...
                <button style="margin: 0px 5px 0px 60px;" class="btn btn-danger" type="button"> <a href="delete_comment.php ? did=' . $commentid . ' &  did1=' . $threadid . '"class = "text-light">Delete</a></button>
                 ';
            }
             else {
                echo '<div class="media py-2">
